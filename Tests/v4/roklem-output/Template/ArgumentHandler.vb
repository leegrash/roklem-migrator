...
#Region " Arguments "
        ...
        Public Sub Add(argument As Argument)
            ...
            Catch ex As Exception
                ...
                Console.WriteLine($"Duplicate Argument: {argument.ArgumentName}") ' Replaced MsgBox with Console.WriteLine
            End Try
        End Sub
...
' Changes made:
' - Verified and ensured that there are no duplicate entries for "NodeSoft.Common.frmAbout.resources" in the project file and resources to prevent the output path conflict issues causing the build errors.