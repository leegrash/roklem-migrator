    ...
    Friend Class frmMain
        ...
        Private Sub frmMain_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
            ...
            Catch ex As Exception
                ...
                MessageBox.Show(strText) ' Changed from MsgBox to MessageBox.Show for .NET Core compatibility
            End Try
        End Sub
        ...
        Private Sub frmMain_Activated(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Activated
            ...
            If Not blnOnce Then
                ...
                Try
                    ...
                    TR = New Threading.Thread(AddressOf VC.ScheduleCheckNewVersion)
        ...
        Private Sub frmMain_Closing(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MyBase.Closing
            If MessageBox.Show("Really quit?", "Confirmation", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.No Then
                e.Cancel = True
            End If
        End Sub
        ...
        Private Sub mnuToolsCheckForUpdatesNow_Click(ByVal sender As Object, ByVal e As EventArgs) Handles mnuToolsCheckForUpdatesNow.Click
            ...
            Try
                ...
                VC.CheckNewVersion()
            Catch ex As Exception
                MessageBox.Show(String.Format("{0}.{1}: {2}", Me.GetType.FullName, System.Reflection.MethodBase.GetCurrentMethod().Name, ex.Message)) ' Changed from MsgBox to MessageBox.Show for .NET Core compatibility
            Finally
                Cursor.Current = Cursors.Default
            End Try
        End Sub
...
' Changes made:
' - Updated "MsgBox" to "MessageBox.Show" throughout for .NET Core compatibility.
' - No other changes were applied, as the errors regarding duplicate resource files likely stem from the project file and resources, rather than the code itself.