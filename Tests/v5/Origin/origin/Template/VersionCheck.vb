...
#Region " Constructors "
		...
		Friend Sub New(pDisclaimer As String)
			Try
				...
				'Vi sparar ett slumptal i registret f�r att f�rs�ka h�lla koll p� hur m�nga anv�ndare vi har.
				...
				'Vill vi ber�tta n�got f�rsta g�ngen programmet k�rs?
				If pDisclaimer <> "" Then
					'�r det f�rsta g�ngen?
					If mIsFirstRun Then
				...
				'Spara lite info om n�r och hur programmet k�rde senast
...
#Region " Register funktioner "
		'
		' Lokala registerfunktioner som tar hand om att alla kanske inte f�r skriva i HKEY_LOCAL_MACHINE\SOFTWARE...
		'
		' Tanken med dessa �r att man f�rst l�ser i HKEY_CURRENT_USER, 
		' om det inte finns d�r s� l�ser man i HKEY_LOCAL_MACHINE.
		'
		' N�r man skriver s� b�rjar man att skriva i HKEY_LOCAL_MACHINE,
		' om inte det lyckas s� skriver man i HKEY_CURRENT_USER.
		'
		' Detta inneb�r att alla administrat�rer kommer att skriva och l�sa i HKEY_LOCAL_MACHINE
		' men alla som inte f�r det har sina egna parametrar (i alla fall de som de har f�rs�kt �ndra).
		'
		' Anledningen till detta var att om en "vanlig" anv�ndare k�rde programmet innan en admin hade
		' k�rt det s� fick han fr�gan om autouppdatering varje g�ng han k�rde det! Svaret kunde ju inte sparas.
		'
		' Om en admin hade k�rt det en g�ng s� s� var det frid och fr�jd tills det hade g�tt en m�nad d� gjorde
		' den "vanliga" anv�ndaren versions koll varje g�ng programmet k�rdes tills en admin hade k�rt det!
		'
		...
		Friend Function SetKeyValue(pTitle As String, pItem As String, pNewValue As String) As Boolean
			...
			'Vi m�ste f�rst prova om det finns en "lokal" f�r anv�ndaren...
			If RegUtilities.GetKeyValue(cHkeyCurrentUserSoftwareNodesoft & pTitle, pItem, cDefValue) = cDefValue Then
				...
				If RegUtilities.GetKeyValue(cHkeyLocalMachineSoftwareNodesoft & pTitle, pItem, cDefValue) <> pNewValue Then
					'Oops... Det gick inte...
					'Skriv det i HKEY_CURRENT_USER ist�llet
		...
		''' <summary>
		''' S�tter registerv�rdet f�r om version skall kontrolleras automatiskt
		''' </summary>
		...
		''' <summary>
		''' H�mtar registerv�rdet f�r om version skall kontrolleras automatiskt
		''' </summary>
