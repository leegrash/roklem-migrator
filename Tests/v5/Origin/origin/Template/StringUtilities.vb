    ...
    Friend Class StringUtilities
        ...
        Public Shared Function GetTextBetweenSeparators(source As String, firstSeparator As String, endSeparator As String) As String
            ...
            If firstSeparator = String.Empty Then
                ...
                End If
                Return String.Empty 'Todo: Jonas la till denna f�r att f� bort en varning. Tidigare stod det Exit Function
            End If
        ...
        Public Shared Function ReplacePartOfKeywordString(longOriginalString As String, keyword As String, stringWithKeyword As String) As String
            Try
                ...
                'Var finns f�rsta delen av strStringWithKeyword i strLongOriginalString?
                Dim firstPosInOriginalString = InStr(longOriginalString, Left(stringWithKeyword, separatorPosition - 1))

                'Ta bort fr�n longOriginalString, det som in
                ...
                While InStr(stringWithKeyword, keyword) > 0
                    ...
                    'B�rjan av strStringWithKeyword fram till strKeyword
                    Dim vStart = Mid(stringWithKeyword, 1, separatorPosition - 1)
                    Dim vEnd As String

                    'strEnd skall inneh�lla det som finns efter strKeyword... men kanske bara fram till n�sta strKeyword
                    If GetPosNum(stringWithKeyword, keyword, True) > 2 Then
                        'Wildcard finns p� mer �n 2 st�lle
        ...
        ' Example ReplaceStringBetween("<H1><title>H�r �r en titel</title></H1>", "<title>", "</title>", "<title>En Ny Titel</title>") will return "<H1><title>En Ny Titel</title></H1>"
        ''' <summary>
