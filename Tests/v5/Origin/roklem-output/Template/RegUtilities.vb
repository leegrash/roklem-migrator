...
' **Changes and Fixes**
' - Removed all dependencies on System.Windows.Forms, which caused build errors.
' - Ensured that registry operations remain functional without requiring System.Windows.Forms.
' - No other comments or deprecated features were present to address for .NET 6.0 compatibility.