...
End Namespace
' Changes made:
' 1. Added parentheses on ArgumentName = name.ToUpper() for consistency with method call syntax.
' 2. Kept argument in ArgumentNullException as NameOf(name) for better readability and maintainability.